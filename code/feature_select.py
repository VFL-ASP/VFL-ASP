...
# feature_names = pd.read_csv('dataset/MIMIC/mimic3d.csv').drop(['hadm_id', 'AdmitDiagnosis', 'AdmitProcedure', 'religion', 'insurance', 'ethnicity', 'marital_status', 'ExpiredHospital', 'LOSdays', 'gender', 'admit_type', 'admit_location'], axis=1).columns
