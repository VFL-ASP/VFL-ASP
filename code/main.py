...
dataset = 'Breast'  # Optional: MIMIC|Breast|Credit
...
if __name__ == '__main__':
    ...
    (X_passive_2, y_passive_2, X_passive_1, y_passive_1, X_active, y_active,
     ...
     p2_shared, p1_shared_2, p1_shared_1, a_shared) = eval('feature_split')(dataset)
    ...
    Emb_a = s2.embedding_approximation()
    ...
    for i in range(100):
        ...
        global_model_2 = GlobalModel(input_size=64,
                                     output_size=2)  # Assuming input size and output size remain suitable
        ...
        # 4 classes for MIMIC, 2 for Breast and Credit, [1000, 100] for Breast, [100, 3] for Credit, [10, 5] for MIMIC
    ...
    for i in range(100):
        ...
        # Train VFL
        vfl.fit(num_epochs=1000, batch_size=50, num_classes=2,
                patience=100)  # 4 classes for MIMIC, 2 classes for Breast
    ...
    for _ in range(100):
        ...
        y_shared_1_tensor = torch.from_numpy(y_shared_1[:int(300 - shared_sample_2), :]).to(
            torch.long)  # Convert to tensor and ensure it's an integer type
